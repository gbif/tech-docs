...
An interval of time may be represented by separating two date-times with equal precision with `/`, for example `2023-09-05/2023-09-18` means some time between 5 September 2023 and 18 September 2023. `2023-01/2023-09` means January to September 2023, `2000/2023` covers 23 years, and `2023-09-10T03:54:00/2023-09-18T13:27:30` is a range with the start and end precise to the second.
