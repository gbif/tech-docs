...
Also note that it's possible to do a lookup on the latest release of a vocabulary: /vocabularies/{vocabularyName}/concepts/latestRelease/lookup
The results might be a different from the pipelines lookup because prefilters are not applied.
