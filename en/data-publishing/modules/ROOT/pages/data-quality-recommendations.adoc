...
Publishers who wish to share DNA reference libraries with GBIF should publish them as https://github.com/gbif/tech-docs/edit/main/en/data-publishing/modules/ROOT/pages/data-quality-recommendations.adoc#data-quality-requirements-for-occurrences[occurrences] with the https://rs.gbif.org/extension/gbif/1.0/dna_derived_data_2024-07-11.xml[DNA-derived data extension]. 

.Data quality requirements for *DNA reference libraries*
[%autowidth,stripes=hover]
|===
|Term |<<Status>> |Status funded GBIF projects 

|<<occurrenceID>>
|Required
|Required

|https://dwc.tdwg.org/list/#dwc_associatedSequences[associatedSequences] (accession number)
|Share if available
|Required
...
|https://dwc.tdwg.org/list/#dwc_typeStatus[typeStatus]
|Strongly recommended
|Strongly recommended

|https://dwc.tdwg.org/list/#dwc_catalogNumber[catalogeNumber]
|Share if available
|Strongly recommended

|https://dwc.tdwg.org/list/#dwc_higherClassification[higherClassification]
|Share if available
|Strongly recommended
...
|https://dwc.tdwg.org/list/#dwc_locality[locality]
|Share if available
|Share if available

|https://dwc.tdwg.org/list/#dwc_identifiedBy[identifiedBy]
|Share if available
|Share if available
|===
