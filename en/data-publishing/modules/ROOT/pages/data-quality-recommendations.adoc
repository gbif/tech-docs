...
|<<associatedSequences>> (accession number)
|Required
|Required
...
==== https://dwc.tdwg.org/terms/#dwc:higherClassification[_dwc:higherClassification]
...
A nucleotide sequence string composed of uppercase IUPAC nucleotide characters (G, A, T, C, R, Y, M, K, S, W, H, B, V, D, N). The string must not include gap characters, whitespace, quality scores, sequence descriptions, or identifiers, and must be provided in the 5′–3′ orientation. The sequence is intended for use in taxon identification and biodiversity assessment.  The corresponding <<target_gene>> from which the sequence is derived must also be specified. 
