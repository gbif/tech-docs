...
NOTE: It is recommended that LocalContexts Projects be set to *Public* before they are added to GBIF data. Public projects allow GBIF to retrieve project metadata via the
