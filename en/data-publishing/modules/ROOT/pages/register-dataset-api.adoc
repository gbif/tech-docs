...
You will need a user account on GBIF.org to handle the registrations.  Ideally, this should be an account for your institution or software system, rather than a personal account.

You should also create an account on GBIF-UAT.org which you can use for testing.  _Please do not create test datasets on GBIF.org! They will be assigned DOIs, which can never be deleted._
