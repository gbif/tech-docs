...
. If column names are quoted they must use double quotes and lowercase: `"year"`, `"basisofrecord"`.  It's only necessary to quote column names that are also SQL functions: `"year"`, `"month"`, `"day"`.
