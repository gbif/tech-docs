...
----
  ...
  AND (identificationVerificationStatus IS NULL <2>
...
<2> Exclude occurrences with these known identification issues
...
[source,sql]
----
CONCAT_WS('-', "year", "month") AS yearMonth <1>
----
...
A cube using this query is available https://www.gbif.org/occurrence/download/0000025-240314170635999[here].
