...
ifeval::["{env}" != "prod"]
WARNING: If you make the same query twice for a Data download within 48 hours, the system will redirect you to the existing download page and it will have the same DOI.
endif::[]
