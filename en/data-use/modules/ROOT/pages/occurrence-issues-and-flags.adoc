...
|Era or Erathem was inferred from a lower rank (System/Period, Series/Epoch, or Stage/Age) since the value provided by the publisher does not correspond to an Era or Erathem.
...
|Period or System was inferred from a lower rank (Series/Epoch or Stage/Age) since the value provided by the publisher does not correspond to a Period or System.
...
|*Epoch or Series*
|Epoch or Series was inferred from a lower rank (Stage/Age) since the value provided by the publisher does not correspond to an Epoch or Series.
