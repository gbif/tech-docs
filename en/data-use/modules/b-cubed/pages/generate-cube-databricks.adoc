...
[NOTE]
====
This tutorial was written in early 2024.  Minor changes may be needed with the current version of DataBricks.
====
...
** Coordinates: `org.gbif.occurrence:cube-hive:1.0.2`
