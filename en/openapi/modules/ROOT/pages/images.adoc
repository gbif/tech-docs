...
Note that occurrence images may be licensed under more restrictive terms than other occurrence data.  Refer to the relevant terms in the multimedia extensions, and contact the publisher of the dataset for confirmation if necessary for your use.
