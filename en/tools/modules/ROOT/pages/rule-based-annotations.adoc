...
To make a rule please select the project and ruleset you want to make a rule in. 

Next, draw a polygon around region you want to make the rule about. Currently, the annotations system is focussed on location based rule-making but this might change in the future. 
