...
See the xref:issue-and-flags.adoc[] or xref:issues-and-flags.adoc[like this].

See the xref:ipt:doi-workflow.adoc#workflows[] xref:ipt:doi-workflow.adoc#workflows[other text].

See the xref:2.5@ipt:doi-workflow.adoc#workflows[] xref:2.5@ipt:doi-workflow.adoc#workflows[other text].
